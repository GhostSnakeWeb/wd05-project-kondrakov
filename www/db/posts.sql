...
(12, 'Математики из Армении создали сервис, который убирает посторонние звуки во время звонков', 'С помощью нейросетей Krisp определяет раздражающие шумы (вроде плача ребёнка или шуршания бумаги) и в реальном времени вырезает их из аудиопотока.', 1, '2019-01-29 20:05:20', NULL, NULL, 9, NULL),
...
(18, 'Google представила новый дизайн мобильных приложений Gmail ', 'Google представила новый дизайн почтового приложения Gmail. В 2018 году компания обновила его веб-версию, а также показала новый Google Drive, «Календарь» и другие сервисы.', 2, '2019-01-30 11:31:06', '657795079.png', '320-657795079.png', 9, NULL),
